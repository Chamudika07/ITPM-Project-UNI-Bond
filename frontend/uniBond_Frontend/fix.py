...
# 1. Add unregisterStudent to destructuring
text = text.replace("""    registerStudent,
    isStudentRegistered,
    getAvailableSeats,
  } = useProfessionalCommunication();""", """    registerStudent,
    unregisterStudent,
    isStudentRegistered,
    getAvailableSeats,
  } = useProfessionalCommunication();""")

# 2. Add handleUnregister after handleRegister
text = text.replace("""  const handleRegister = async (sessionId: string) => {
