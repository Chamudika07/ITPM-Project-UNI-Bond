...
export default function ProfileHeader({ user, onLogout }: Props) {
  return (
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative flex flex-col sm:flex-row justify-between items-center sm:items-end sm:-mt-24 mb-4 gap-4 sm:gap-0">
          <div className="-mt-16 sm:mt-0 flex bg-white p-1 rounded-full shrink-0 shadow-lg">
            <img 
              src={`https://ui-avatars.com/api/?name=${user.firstname}+${user.lastname}&background=random&size=160`} 
              alt="Profile" 
        ...
        <div className="mt-2 text-center sm:text-left">
          ...
          <div className="flex gap-4 mt-4 text-sm font-medium text-gray-600 justify-center sm:justify-start">
            <span className="hover:underline cursor-pointer"><strong className="text-gray-900">420</strong> Followers</span>
            <span className="hover:underline cursor-pointer"><strong className="text-gray-900">69</strong> Following</span>
          </div>
        </div>
      </div>
    </div>
